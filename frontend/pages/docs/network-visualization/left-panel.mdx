...
| OpenTargets               | OpenTargets\_<pre className="inline text-red-500">CustomName</pre>          | [0, 1]                                                                                                      |
