...
| Custom                        | Custom\_Color\_<pre className="inline text-red-500">CustomName</pre>      | Any hex color code or CSS color name, see list [here ↗](https://www.w3schools.com/colors/colors_names.asp)  |
