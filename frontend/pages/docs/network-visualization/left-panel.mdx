...
| GDA               | GDA_<pre className="inline text-red-500">CustomName</pre>          | [0, 1]               |
| Genetics          | GWAS_<pre className="inline text-red-500">CustomName</pre>         | [-1, 1]              |
...
| Tissue Enrichment | TE_<pre className="inline text-red-500">CustomName</pre>           | [0, +Inf]            |
| Database          | Database_<pre className="inline text-red-500">CustomName</pre>     | Binary (0/1)         |
