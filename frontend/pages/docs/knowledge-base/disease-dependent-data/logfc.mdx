...
You can use the Verge data to color or resize the nodes in the network. The name in the dropdown list of LogFC Verge data follows the format of **\{data type\}\_\{"DEGS"\}\_\{tissue Abbr.\}\_\{"log2FoldChange"\}**, for example, "PSP\_LogFC\_Verge\_DEGS\_GP\_log2FoldChange", shown as below:
