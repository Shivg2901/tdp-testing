...
const DISEASE_DEPENDENT_FIELDS = ["OpenTargets", "LogFC", "Genetics"];
...
const args = yargs(process.argv.slice(2))
  ...
  .example(
    chalk.blue(
      "node $0 -U bolt://localhost:7687 -u neo4j -p password -d pdnet -D MONDO_0004976 -t Genetics -H p-value,OR"
    )
  )
